...
curl -v -u $COUCHBASE_ADMIN_USERNAME:$COUCHBASE_ADMIN_PASSWORD \
     -X PUT http://127.0.0.1:8091/settings/rbac/users/local/$COUCHBASE_ADMIN_USERNAME \
...
curl -v -u $COUCHBASE_ADMIN_USERNAME:$COUCHBASE_ADMIN_PASSWORD \
     -X POST http://127.0.0.1:8091/pools/default/buckets/$COUCHBASE_BUCKET/scopes \
     -d name=usuarios
...
curl -v -u $COUCHBASE_ADMIN_USERNAME:$COUCHBASE_ADMIN_PASSWORD \
     -X POST http://127.0.0.1:8091/pools/default/buckets/$COUCHBASE_BUCKET/scopes/usuarios/collections \
     -d name=usuario
...
curl -v -u $COUCHBASE_ADMIN_USERNAME:$COUCHBASE_ADMIN_PASSWORD \
     -X POST http://127.0.0.1:8091/pools/default/buckets/$COUCHBASE_BUCKET/scopes/chats/collections \
     -d name=chatGrupo
...
curl -v -u $COUCHBASE_ADMIN_USERNAME:$COUCHBASE_ADMIN_PASSWORD \
    -X POST http://127.0.0.1:8091/pools/default/buckets/$COUCHBASE_BUCKET/scopes/documentos/collections \
    -d name=documento   
